        ...
        <div className="max-w-5xl mx-auto">
          { courseState === "purchased" &&
            <Message type="warning">
              ...
              <i className="block font-normal">In case of any questions, please contact info@gne-project.com</i>
            </Message>
          }
          ...
          { courseState === "deactivated" &&
            <Message type="danger">
              ...
              The functionality to watch the NFT has been temporaly disabled.
              <i className="block font-normal">Please contact info@gne-project.com</i>
            </Message>
          }
        </div>
      }
